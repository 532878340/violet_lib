...
import com.violet.library.pulltorefresh.ILoadingLayout.State;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mRefreshableView.setVerticalScrollBarEnabled(false);
    ...
    final class SmoothScrollRunnable implements Runnable {
        ...
        public void run() {
            ...
            if (mStartTime == -1) {
                ...
                /**
                 * We do do all calculations in long to reduce software windows
    ...
    public void setPullCompletedAndDate(boolean setDate){
        if(setDate) setLastUpdatedLabel(DateFormatUtils.getCurrentTime());
