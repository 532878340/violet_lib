...
public final class Arith {
    ...
    public static void main(String[] args) {
        System.out.println(round(0.475, 2));
        System.out.println(round(0.474, 2));
        System.out.println(round(4.005, 2));
        System.out.println(round(4.004, 2));
        System.out.println(round(0.115, 2));
    }
    ...
    /**
     * 提供精确的小数位四舍五入处理，并保留两位小数
     * @param v
     *            需要四舍五入的数字
     * @return double
     * 			  四舍五入后的结果
     */
    public static double round2Digit(double v) {
        return round(v, 2);
    }
}
