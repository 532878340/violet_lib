 ...
 */
package com.violet.library.views.pageindicator;
...
public class LinePageIndicator extends View implements PageIndicator {
    ...
    public LinePageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        final int defaultSelectedColor = res.getColor(R.color.default_circle_indicator_page_color);
        final int defaultUnselectedColor = res.getColor(R.color.default_circle_indicator_fill_color);
        final float defaultLineWidth = res.getDimension(R.dimen.default_circle_indicator_radius);
        final float defaultGapWidth = res.getDimension(R.dimen.default_circle_indicator_radius);
        final float defaultStrokeWidth = res.getDimension(R.dimen.default_circle_indicator_radius);
